...
cdef void update_stresses(Field *grid,                                         # Grid of field values
    ...
    It has been included to be most general.
    """
    ...
    # We are looking at grid point (x, y, z). This is grouped with grid point (x+1/2, y+1/2, z + 1/2).
...
cdef void update_velocities(Field *grid,                                        # Grid of field values
    ...
    cdef:
        ...
        np.float64_t kap = .015       # viscosity fudge factor to smooth out divergences
